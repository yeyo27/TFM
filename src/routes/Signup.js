                        ...
                        <div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-3 text-sm">
                                    <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">I accept the <a className="font-medium text-blue-600 hover:underline" href="/terms_and_conditions" target="_blank">Terms and Conditions</a></label>
                                </div>
                            </div>
